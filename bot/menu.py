from bot.handlers import duvida, servico, buscarProduto
...
def mostrar_menu():
    ...
    print("4 - Ver horário de funcionamento")
    print("5 - Consultar preços de serviços")
    print("6 - Localização e contato")
